...
import pip.com.apkmuslimquran.ui.dzikir.CustomZoom.CenterZoomLayout
import pip.com.apkmuslimquran.ui.dzikir.DzikirAdapter
...
class DzikirPetang : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        back_dzikir_petang  .setOnClickListener{
            val intent = Intent(this, DzikirFragment::class.java)
            finish()
        }

        //init views
        val rv_dzikir_petang = findViewById<RecyclerView>(R.id.rv_dzikir_petang)
...
//        init layout manager here
        ...
        rv_dzikir_petang.layoutManager = layoutManager

        //To Auto Center Views
        val snapHelper = LinearSnapHelper()
        snapHelper.attachToRecyclerView(rv_dzikir_petang)
        rv_dzikir_petang.isNestedScrollingEnabled = false

        //add items to array list
        val dzikir = ArrayList<Dzikir>()
        ...
        dzikir.add(
            Dzikir(
                ...
                "https://imgbb.online/images/2020/12/29/Android---14-548dd055da54979c3.png"
            )
        )
...
//                null,
//                null,
//                "https://imgbb.online/images/2020/12/29/Android---18-2.png"
//            )
//        )
        ...
        rv_dzikir_petang.adapter = DzikirAdapter(this, dzikir)
    }
}